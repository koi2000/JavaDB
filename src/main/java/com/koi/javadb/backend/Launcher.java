package com.koi.javadb.backend;

import com.koi.javadb.backend.dm.DataManager;
import com.koi.javadb.backend.server.Server;
...
import com.koi.javadb.backend.vm.VersionManagerImpl;
...
public class Launcher {
    ...
    private static long parseMem(String memStr) {
        ...
        if (memStr.length() < 2) {
            Panic.panic(Errors.InvalidMemException);
        }
